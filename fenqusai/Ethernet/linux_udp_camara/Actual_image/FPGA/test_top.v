...
wire [31:0]rgb;
assign     rgb        =   {{i_rgb565[15:11],i_rgb565[15:13],2'b0}, {i_rgb565[10:5],i_rgb565[10:9],2'b0}, {i_rgb565[4:0],i_rgb565[4:2],4'b0 }};
...
// reg r_eth_rgmii_txc_0/* synthesis PAP_MARK_DEBUG="1" */;
// reg r_eth_rgmii_tx_ctl_0/* synthesis PAP_MARK_DEBUG="1" */;
// reg [3:0]r_eth_rgmii_txd_0/* synthesis PAP_MARK_DEBUG="1" */;
    // always @(posedge rgmii_clk_0)
    // begin
    // r_eth_rgmii_txc_0 <= eth_rgmii_txc_0;
	// r_eth_rgmii_tx_ctl_0 <= eth_rgmii_tx_ctl_0;
	// r_eth_rgmii_txd_0 <= eth_rgmii_txd_0;
	// end
endmodule